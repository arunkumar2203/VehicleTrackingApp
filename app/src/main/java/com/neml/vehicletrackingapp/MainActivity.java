package com.neml.vehicletrackingapp;
...
import com.neml.vehicletrackingapp.model.UserViewModel;
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isValid)
                {
                    ...
                    Log.d("Successful_Login", "Login was successful");
                }
                else
                {
                    Toast.makeText(getBaseContext(), "Invalid Login!", Toast.LENGTH_SHORT).show();
                    Log.d("Unsuccessful_Login", "Login was not successful");
                }
            }
        });
    }
